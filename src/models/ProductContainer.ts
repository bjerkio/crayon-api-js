...
export function ProductContainerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductContainer {
    ...
    return {
        ...
        'usageMonth': !exists(json, 'usageMonth') ? undefined : (new Date(json['usageMonth'])),
        ...
        'axContactUserId': !exists(json, 'axContactUserId') ? undefined : json['axContactUserId'],
        'createdDate': !exists(json, 'createdDate') ? undefined : (new Date(json['createdDate'])),
        'orderStatusChangedDate': !exists(json, 'orderStatusChangedDate') ? undefined : (json['orderStatusChangedDate'] === null ? null : new Date(json['orderStatusChangedDate'])),
        'contactUser': !exists(json, 'contactUser') ? undefined : UserProfileFromJSON(json['contactUser']),
        ...
        'productRows': !exists(json, 'productRows') ? undefined : (json['productRows'] === null ? null : (json['productRows'] as Array<any>).map(ProductRowFromJSON)),
        'comments': !exists(json, 'comments') ? undefined : (json['comments'] === null ? null : (json['comments'] as Array<any>).map(ProductContainerCommentFromJSON)),
        'invoiceProfile': !exists(json, 'invoiceProfile') ? undefined : InvoiceProfileFromJSON(json['invoiceProfile']),
        ...
        'type': !exists(json, 'type') ? undefined : ProductContainerTypeFromJSON(json['type']),
        'category': !exists(json, 'category') ? undefined : ProductContainerCategoryFromJSON(json['category']),
        'quoteValidToDate': !exists(json, 'quoteValidToDate') ? undefined : (new Date(json['quoteValidToDate'])),
        'totalSalesPrice': !exists(json, 'totalSalesPrice') ? undefined : (json['totalSalesPrice'] === null ? null : (json['totalSalesPrice'] as Array<any>).map(PriceFromJSON)),
        'totalAlternativeSalesPrice': !exists(json, 'totalAlternativeSalesPrice') ? undefined : (json['totalAlternativeSalesPrice'] === null ? null : (json['totalAlternativeSalesPrice'] as Array<any>).map(PriceFromJSON)),
        'issues': !exists(json, 'issues') ? undefined : (json['issues'] === null ? null : (json['issues'] as Array<any>).map(ProductContainerIssueFromJSON)),
        'submittedBy': !exists(json, 'submittedBy') ? undefined : ProductContainerCommentUserFromJSON(json['submittedBy']),
...
export function ProductContainerToJSON(value?: ProductContainer | null): any {
    ...
    return {
        ...
        'note': value.note,
        'usageMonth': value.usageMonth === undefined ? undefined : (value.usageMonth.toISOString()),
        'name': value.name,
        ...
        'orderStatusChangedDate': value.orderStatusChangedDate === undefined ? undefined : (value.orderStatusChangedDate === null ? null : value.orderStatusChangedDate.toISOString()),
        ...
        'productRows': value.productRows === undefined ? undefined : (value.productRows === null ? null : (value.productRows as Array<any>).map(ProductRowToJSON)),
        'comments': value.comments === undefined ? undefined : (value.comments === null ? null : (value.comments as Array<any>).map(ProductContainerCommentToJSON)),
        ...
        'quoteValidToDate': value.quoteValidToDate === undefined ? undefined : (value.quoteValidToDate.toISOString()),
        'totalSalesPrice': value.totalSalesPrice === undefined ? undefined : (value.totalSalesPrice === null ? null : (value.totalSalesPrice as Array<any>).map(PriceToJSON)),
        'totalAlternativeSalesPrice': value.totalAlternativeSalesPrice === undefined ? undefined : (value.totalAlternativeSalesPrice === null ? null : (value.totalAlternativeSalesPrice as Array<any>).map(PriceToJSON)),
        'issues': value.issues === undefined ? undefined : (value.issues === null ? null : (value.issues as Array<any>).map(ProductContainerIssueToJSON)),
