...
export function AssetOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetOrder {
    ...
    return {
        ...
        'adminAccount': !exists(json, 'adminAccount') ? undefined : json['adminAccount'],
        ...
        'errors': !exists(json, 'errors') ? undefined : (json['errors'] === null ? null : (json['errors'] as Array<any>).map(AssetOrderErrorFromJSON)),
        'orderLines': !exists(json, 'orderLines') ? undefined : (json['orderLines'] === null ? null : (json['orderLines'] as Array<any>).map(AssetOrderLineFromJSON)),
    };
}
...
export function AssetOrderToJSON(value?: AssetOrder | null): any {
    ...
    return {
        ...
        'errors': value.errors === undefined ? undefined : (value.errors === null ? null : (value.errors as Array<any>).map(AssetOrderErrorToJSON)),
        'orderLines': value.orderLines === undefined ? undefined : (value.orderLines === null ? null : (value.orderLines as Array<any>).map(AssetOrderLineToJSON)),
    };
}
