...
export function SecretFromJSONTyped(json: any, ignoreDiscriminator: boolean): Secret {
    ...
    return {
        ...
        'expiration': !exists(json, 'expiration') ? undefined : (json['expiration'] === null ? null : new Date(json['expiration'])),
...
export function SecretToJSON(value?: Secret | null): any {
    ...
    return {
        ...
        'expiration': value.expiration === undefined ? undefined : (value.expiration === null ? null : value.expiration.toISOString()),
