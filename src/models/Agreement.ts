...
export function AgreementFromJSONTyped(json: any, ignoreDiscriminator: boolean): Agreement {
    ...
    return {
        ...
        'salesPriceCurrencyCode': !exists(json, 'salesPriceCurrencyCode') ? undefined : json['salesPriceCurrencyCode'],
        ...
        'masterAgreement': !exists(json, 'masterAgreement') ? undefined : json['masterAgreement'],
        ...
        'parentAgreementId': !exists(json, 'parentAgreementId') ? undefined : json['parentAgreementId'],
