...
export function ClientFromJSONTyped(
  json: any,
  ...
  return {
    ...
    clientSecrets: !exists(json, 'clientSecrets')
      ? undefined
      : json['clientSecrets'] === null
      ? null
      : (json['clientSecrets'] as Array<any>).map(SecretFromJSON),
    redirectUris: !exists(json, 'redirectUris')
      ? undefined
      : json['redirectUris'],
...
export function ClientToJSON(value?: Client | null): any {
  ...
  return {
    ...
    clientSecrets:
      value.clientSecrets === undefined
        ? undefined
        : value.clientSecrets === null
        ? null
        : (value.clientSecrets as Array<any>).map(SecretToJSON),
