...
export function OrganizationAccessFromJSONTyped(
  json: any,
  ...
  return {
    ...
    allAgreements: !exists(json, 'allAgreements')
      ? undefined
      : json['allAgreements'],
    agreements: !exists(json, 'agreements')
      ? undefined
      : json['agreements'] === null
      ? null
      : (json['agreements'] as Array<any>).map(AgreementAccessFromJSON),
    ...
    role: !exists(json, 'role')
      ? undefined
      : OrganizationAccessRoleFromJSON(json['role']),
    crayonCompanyName: !exists(json, 'crayonCompanyName')
      ? undefined
      : json['crayonCompanyName'],
...
export function OrganizationAccessToJSON(
  ...
  return {
    ...
    agreements:
      value.agreements === undefined
        ? undefined
        : value.agreements === null
        ? null
        : (value.agreements as Array<any>).map(AgreementAccessToJSON),
