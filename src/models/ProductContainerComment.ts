...
export function ProductContainerCommentFromJSON(json: any): ProductContainerComment {
    return ProductContainerCommentFromJSONTyped(json, false);
}

export function ProductContainerCommentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductContainerComment {
    ...
    return {
        ...
        'user': !exists(json, 'user') ? undefined : ProductContainerCommentUserFromJSON(json['user']),
        ...
        'productContainerCommentType': !exists(json, 'productContainerCommentType') ? undefined : ProductContainerCommentTypeFromJSON(json['productContainerCommentType']),
    };
}

export function ProductContainerCommentToJSON(value?: ProductContainerComment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'productContainerCommentType': ProductContainerCommentTypeToJSON(value.productContainerCommentType),
    };
}
