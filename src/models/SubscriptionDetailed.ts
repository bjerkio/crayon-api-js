...
export function SubscriptionDetailedFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriptionDetailed {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'effectiveStartDate': !exists(json, 'effectiveStartDate') ? undefined : (new Date(json['effectiveStartDate'])),
        'commitmentEndDate': !exists(json, 'commitmentEndDate') ? undefined : (new Date(json['commitmentEndDate'])),
        'suspensionReasons': !exists(json, 'suspensionReasons') ? undefined : json['suspensionReasons'],
        'originalAgreementId': !exists(json, 'originalAgreementId') ? undefined : json['originalAgreementId'],
        'pricing': !exists(json, 'pricing') ? undefined : SubscriptionPricingFromJSON(json['pricing']),
        'attestationAccepted': !exists(json, 'attestationAccepted') ? undefined : json['attestationAccepted'],
        'id': !exists(json, 'id') ? undefined : json['id'],
        'publisherSubscriptionId': !exists(json, 'publisherSubscriptionId') ? undefined : json['publisherSubscriptionId'],
        'entitlementId': !exists(json, 'entitlementId') ? undefined : json['entitlementId'],
        ...
        'availableAddonsCount': !exists(json, 'availableAddonsCount') ? undefined : json['availableAddonsCount'],
        'subscriptions': !exists(json, 'subscriptions') ? undefined : (json['subscriptions'] === null ? null : (json['subscriptions'] as Array<any>).map(SubscriptionAddOnFromJSON)),
        ...
        'priceType': !exists(json, 'priceType') ? undefined : SubscriptionPriceTypeFromJSON(json['priceType']),
        ...
        'acceptAutoSuspension': !exists(json, 'acceptAutoSuspension') ? undefined : json['acceptAutoSuspension'],
        'autoSuspensionDate': !exists(json, 'autoSuspensionDate') ? undefined : (json['autoSuspensionDate'] === null ? null : new Date(json['autoSuspensionDate'])),
...
export function SubscriptionDetailedToJSON(value?: SubscriptionDetailed | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'effectiveStartDate': value.effectiveStartDate === undefined ? undefined : (value.effectiveStartDate.toISOString()),
        'commitmentEndDate': value.commitmentEndDate === undefined ? undefined : (value.commitmentEndDate.toISOString()),
        ...
        'subscriptions': value.subscriptions === undefined ? undefined : (value.subscriptions === null ? null : (value.subscriptions as Array<any>).map(SubscriptionAddOnToJSON)),
        ...
        'autoSuspensionDate': value.autoSuspensionDate === undefined ? undefined : (value.autoSuspensionDate === null ? null : value.autoSuspensionDate.toISOString()),
