...
export function GoogleOrderFromJSONTyped(
  json: any,
  ...
  return {
    ...
    consumerCountry: !exists(json, 'consumerCountry')
      ? undefined
      : json['consumerCountry'],
    consumerStreetAddress: !exists(json, 'consumerStreetAddress')
      ? undefined
      : json['consumerStreetAddress'],
    consumerCity: !exists(json, 'consumerCity')
      ? undefined
      : json['consumerCity'],
    consumerState: !exists(json, 'consumerState')
      ? undefined
      : json['consumerState'],
    consumerZipCode: !exists(json, 'consumerZipCode')
      ? undefined
      : json['consumerZipCode'],
    consumerPhoneNumber: !exists(json, 'consumerPhoneNumber')
      ? undefined
      : json['consumerPhoneNumber'],
    primaryAdminName: !exists(json, 'primaryAdminName')
      ? undefined
      : json['primaryAdminName'],
    primaryAdminUserName: !exists(json, 'primaryAdminUserName')
      ? undefined
      : json['primaryAdminUserName'],
  };
}
