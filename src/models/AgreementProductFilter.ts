...
export function AgreementProductFilterFromJSON(json: any): AgreementProductFilter {
    return AgreementProductFilterFromJSONTyped(json, false);
}

export function AgreementProductFilterFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgreementProductFilter {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'agreementTypeIds': !exists(json, 'agreementTypeIds') ? undefined : (json['agreementTypeIds'] === null ? null : (json['agreementTypeIds'] as Array<any>).map(AgreementTypeFromJSON)),
        ...
        'agreementIds': !exists(json, 'agreementIds') ? undefined : json['agreementIds'],
        'searchDate': !exists(json, 'searchDate') ? undefined : (json['searchDate'] === null ? null : new Date(json['searchDate'])),
        'include': !exists(json, 'include') ? undefined : AgreementProductsSubFilterFromJSON(json['include']),
        'exclude': !exists(json, 'exclude') ? undefined : AgreementProductsSubFilterFromJSON(json['exclude']),
        'sortKey': !exists(json, 'sortKey') ? undefined : json['sortKey'],
        'includeProductInformation': !exists(json, 'includeProductInformation') ? undefined : json['includeProductInformation'],
        'sortOrder': !exists(json, 'sortOrder') ? undefined : SortOrderFromJSON(json['sortOrder']),
    };
}

export function AgreementProductFilterToJSON(value?: AgreementProductFilter | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'agreementTypeIds': value.agreementTypeIds === undefined ? undefined : (value.agreementTypeIds === null ? null : (value.agreementTypeIds as Array<any>).map(AgreementTypeToJSON)),
        'page': value.page,
        ...
        'searchDate': value.searchDate === undefined ? undefined : (value.searchDate === null ? null : value.searchDate.toISOString()),
