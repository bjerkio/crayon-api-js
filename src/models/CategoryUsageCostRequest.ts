...
export function CategoryUsageCostRequestFromJSON(
  json: any,
): CategoryUsageCostRequest {
  return CategoryUsageCostRequestFromJSONTyped(json, false);
}

export function CategoryUsageCostRequestFromJSONTyped(
  json: any,
...
export function CategoryUsageCostRequestToJSON(
  value?: CategoryUsageCostRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
