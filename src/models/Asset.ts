...
export function AssetFromJSONTyped(
  ...
  return {
    ...
    scope: !exists(json, 'scope')
      ? undefined
      : AssetScopeFromJSON(json['scope']),
    assetType: !exists(json, 'assetType')
      ? undefined
      : AssetTypeFromJSON(json['assetType']),
    billingCycle: !exists(json, 'billingCycle')
      ? undefined
      : BillingCycleTypeFromJSON(json['billingCycle']),
    publisherId: !exists(json, 'publisherId') ? undefined : json['publisherId'],
    programId: !exists(json, 'programId') ? undefined : json['programId'],
    reservationId: !exists(json, 'reservationId')
      ? undefined
      : json['reservationId'],
    reservationUsedInSubscriptionId: !exists(
      json,
      'reservationUsedInSubscriptionId',
    )
      ? undefined
      : json['reservationUsedInSubscriptionId'],
    reservationUsedInSubscription: !exists(
      json,
      'reservationUsedInSubscription',
    )
      ? undefined
      : SubscriptionLiteFromJSON(json['reservationUsedInSubscription']),
    purchaseCurrency: !exists(json, 'purchaseCurrency')
      ? undefined
      : json['purchaseCurrency'],
    purchasePrice: !exists(json, 'purchasePrice')
      ? undefined
      : json['purchasePrice'],
    salesCurrency: !exists(json, 'salesCurrency')
      ? undefined
      : json['salesCurrency'],
    ...
    resellerPriceType: !exists(json, 'resellerPriceType')
      ? undefined
      : SalesPriceTypeFromJSON(json['resellerPriceType']),
    resellerPriceTypeValue: !exists(json, 'resellerPriceTypeValue')
      ? undefined
      : json['resellerPriceTypeValue'],
    reservedInstanceArtifactResourceId: !exists(
      json,
      'reservedInstanceArtifactResourceId',
    )
      ? undefined
      : json['reservedInstanceArtifactResourceId'],
...
export function AssetToJSON(value?: Asset | null): any {
  ...
  return {
    ...
    reservationUsedInSubscription: SubscriptionLiteToJSON(
      value.reservationUsedInSubscription,
    ),
    ...
    reservedInstanceArtifactResourceId:
      value.reservedInstanceArtifactResourceId,
    purchaseDate:
