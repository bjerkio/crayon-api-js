...
export function CustomerTenantProfileFromJSON(
  json: any,
): CustomerTenantProfile {
  return CustomerTenantProfileFromJSONTyped(json, false);
}

export function CustomerTenantProfileFromJSONTyped(
  json: any,
  ...
  return {
    ...
    languageCode: !exists(json, 'languageCode')
      ? undefined
      : json['languageCode'],
    contact: !exists(json, 'contact')
      ? undefined
      : CustomerTenantContactFromJSON(json['contact']),
    address: !exists(json, 'address')
      ? undefined
      : CustomerTenantAddressFromJSON(json['address']),
...
export function CustomerTenantProfileToJSON(
  value?: CustomerTenantProfile | null,
): any {
  if (value === undefined) {
    return undefined;
  }
