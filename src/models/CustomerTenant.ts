...
export function CustomerTenantFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomerTenant {
    ...
    return {
        ...
        'consumer': !exists(json, 'consumer') ? undefined : ObjectReferenceFromJSON(json['consumer']),
        'resellerMarkup': !exists(json, 'resellerMarkup') ? undefined : json['resellerMarkup'],
        'defaultSubscriptionPriceType': !exists(json, 'defaultSubscriptionPriceType') ? undefined : SubscriptionPriceTypeFromJSON(json['defaultSubscriptionPriceType']),
...
export function CustomerTenantToJSON(value?: CustomerTenant | null): any {
    ...
    return {
        ...
        'defaultSubscriptionPriceType': SubscriptionPriceTypeToJSON(value.defaultSubscriptionPriceType),
