...
export function CustomerTenantAddressFromJSON(
  json: any,
): CustomerTenantAddress {
  return CustomerTenantAddressFromJSONTyped(json, false);
}

export function CustomerTenantAddressFromJSONTyped(
  json: any,
  ...
  return {
    ...
    addressLine2: !exists(json, 'addressLine2')
      ? undefined
      : json['addressLine2'],
    addressLine3: !exists(json, 'addressLine3')
      ? undefined
      : json['addressLine3'],
...
export function CustomerTenantAddressToJSON(
  value?: CustomerTenantAddress | null,
): any {
  if (value === undefined) {
    return undefined;
  }
