...
export function FacebookOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): FacebookOrder {
    ...
    return {
        ...
        'consumerSignupEmail': !exists(json, 'consumerSignupEmail') ? undefined : json['consumerSignupEmail'],
    };
}
