...
export function OrganizationUsageCostFromJSON(json: any): OrganizationUsageCost {
    return OrganizationUsageCostFromJSONTyped(json, false);
}

export function OrganizationUsageCostFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrganizationUsageCost {
...
export function OrganizationUsageCostToJSON(value?: OrganizationUsageCost | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
