...
export function ProductRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductRow {
    ...
    return {
        ...
        'productContainerId': !exists(json, 'productContainerId') ? undefined : json['productContainerId'],
        'quantity': !exists(json, 'quantity') ? undefined : json['quantity'],
        'comment': !exists(json, 'comment') ? undefined : json['comment'],
        'usageCountryCode': !exists(json, 'usageCountryCode') ? undefined : json['usageCountryCode'],
        'salesUnitPrice': !exists(json, 'salesUnitPrice') ? undefined : PriceFromJSON(json['salesUnitPrice']),
        'alternativeSalesUnitPrice': !exists(json, 'alternativeSalesUnitPrice') ? undefined : PriceFromJSON(json['alternativeSalesUnitPrice']),
        ...
        'agreement': !exists(json, 'agreement') ? undefined : AgreementIdentityReferenceFromJSON(json['agreement']),
        'product': !exists(json, 'product') ? undefined : ProductReferenceFromJSON(json['product']),
        'user': !exists(json, 'user') ? undefined : ProductRowUserFromJSON(json['user']),
        ...
        'grouping': !exists(json, 'grouping') ? undefined : GroupingFromJSON(json['grouping']),
        'issues': !exists(json, 'issues') ? undefined : (json['issues'] === null ? null : (json['issues'] as Array<any>).map(ProductContainerIssueFromJSON)),
        'offeringType': !exists(json, 'offeringType') ? undefined : json['offeringType'],
        'priceCalculation': !exists(json, 'priceCalculation') ? undefined : PriceCalculationTypeFromJSON(json['priceCalculation']),
        ...
        'salesPricePerAlternativeUnit': !exists(json, 'salesPricePerAlternativeUnit') ? undefined : json['salesPricePerAlternativeUnit'],
