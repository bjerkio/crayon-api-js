...
export function SubscriptionAddOnOfferFromJSON(json: any): SubscriptionAddOnOffer {
    return SubscriptionAddOnOfferFromJSONTyped(json, false);
}

export function SubscriptionAddOnOfferFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriptionAddOnOffer {
...
export function SubscriptionAddOnOfferToJSON(value?: SubscriptionAddOnOffer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
