...
export function ProductReferenceFromJSONTyped(
  json: any,
  ...
  return {
    ...
    publisherProductId: !exists(json, 'publisherProductId')
      ? undefined
      : json['publisherProductId'],
    itemLegalName: !exists(json, 'itemLegalName')
      ? undefined
      : json['itemLegalName'],
