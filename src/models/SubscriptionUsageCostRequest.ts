...
export function SubscriptionUsageCostRequestFromJSON(
  json: any,
): SubscriptionUsageCostRequest {
  return SubscriptionUsageCostRequestFromJSONTyped(json, false);
}

export function SubscriptionUsageCostRequestFromJSONTyped(
  json: any,
...
export function SubscriptionUsageCostRequestToJSON(
  value?: SubscriptionUsageCostRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
