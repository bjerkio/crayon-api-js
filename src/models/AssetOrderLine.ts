...
export function AssetOrderLineFromJSONTyped(
  json: any,
  ...
  return {
    ...
    subscriptionId: !exists(json, 'subscriptionId')
      ? undefined
      : json['subscriptionId'],
    armRegionName: !exists(json, 'armRegionName')
      ? undefined
      : json['armRegionName'],
    ...
    provisioningContext: !exists(json, 'provisioningContext')
      ? undefined
      : json['provisioningContext'],
    type: !exists(json, 'type') ? undefined : AssetTypeFromJSON(json['type']),
    requiresInventoryCheck: !exists(json, 'requiresInventoryCheck')
      ? undefined
      : json['requiresInventoryCheck'],
    ...
    errors: !exists(json, 'errors')
      ...
      : json['errors'] === null
      ? null
      : (json['errors'] as Array<any>).map(AssetOrderLineErrorFromJSON),
  };
}
  ...
  return {
    ...
    errors:
      value.errors === undefined
        ...
        : value.errors === null
        ? null
        : (value.errors as Array<any>).map(AssetOrderLineErrorToJSON),
  };
}
