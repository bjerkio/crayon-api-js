...
export function SubcategoryUsageCostRequestFromJSON(
  json: any,
): SubcategoryUsageCostRequest {
  return SubcategoryUsageCostRequestFromJSONTyped(json, false);
}

export function SubcategoryUsageCostRequestFromJSONTyped(
  json: any,
...
export function SubcategoryUsageCostRequestToJSON(
  value?: SubcategoryUsageCostRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
