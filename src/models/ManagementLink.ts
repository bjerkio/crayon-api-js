...
export function ManagementLinkFromJSONTyped(json: any, ignoreDiscriminator: boolean): ManagementLink {
    ...
    return {
        ...
        'subscription': !exists(json, 'subscription') ? undefined : ObjectReferenceFromJSON(json['subscription']),
