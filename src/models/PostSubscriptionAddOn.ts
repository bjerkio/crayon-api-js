...
export function PostSubscriptionAddOnFromJSON(
  json: any,
): PostSubscriptionAddOn {
  return PostSubscriptionAddOnFromJSONTyped(json, false);
}

export function PostSubscriptionAddOnFromJSONTyped(
  json: any,
...
export function PostSubscriptionAddOnToJSON(
  value?: PostSubscriptionAddOn | null,
): any {
  if (value === undefined) {
    return undefined;
  }
