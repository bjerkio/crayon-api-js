...
export function AgreementProductsSubFilterFromJSON(
  json: any,
): AgreementProductsSubFilter {
  return AgreementProductsSubFilterFromJSONTyped(json, false);
}

export function AgreementProductsSubFilterFromJSONTyped(
  json: any,
  ...
  return {
    ...
    publisherIds: !exists(json, 'publisherIds')
      ? undefined
      : json['publisherIds'],
    publisherNames: !exists(json, 'publisherNames')
      ? undefined
      : json['publisherNames'],
    poolNames: !exists(json, 'poolNames') ? undefined : json['poolNames'],
    operatingSystemNames: !exists(json, 'operatingSystemNames')
      ? undefined
      : json['operatingSystemNames'],
    levelNames: !exists(json, 'levelNames') ? undefined : json['levelNames'],
    languageNames: !exists(json, 'languageNames')
      ? undefined
      : json['languageNames'],
    licenseAgreementTypeNames: !exists(json, 'licenseAgreementTypeNames')
      ? undefined
      : json['licenseAgreementTypeNames'],
    licenseTypeNames: !exists(json, 'licenseTypeNames')
      ? undefined
      : json['licenseTypeNames'],
    productFamilyNames: !exists(json, 'productFamilyNames')
      ? undefined
      : json['productFamilyNames'],
    productTypeNames: !exists(json, 'productTypeNames')
      ? undefined
      : json['productTypeNames'],
    programNames: !exists(json, 'programNames')
      ? undefined
      : json['programNames'],
    offeringNames: !exists(json, 'offeringNames')
      ? undefined
      : json['offeringNames'],
    purchasePeriodNames: !exists(json, 'purchasePeriodNames')
      ? undefined
      : json['purchasePeriodNames'],
    purchaseUnitNames: !exists(json, 'purchaseUnitNames')
      ? undefined
      : json['purchaseUnitNames'],
    versionNames: !exists(json, 'versionNames')
      ? undefined
      : json['versionNames'],
    regionNames: !exists(json, 'regionNames') ? undefined : json['regionNames'],
    productCategoryNames: !exists(json, 'productCategoryNames')
      ? undefined
      : json['productCategoryNames'],
    catalogNames: !exists(json, 'catalogNames')
      ? undefined
      : json['catalogNames'],
    billingCycles: !exists(json, 'billingCycles')
      ? undefined
      : json['billingCycles'],
  };
}

export function AgreementProductsSubFilterToJSON(
  value?: AgreementProductsSubFilter | null,
): any {
  if (value === undefined) {
    return undefined;
  }
