...
export function ResourceGroupUsageCostRequestFromJSON(json: any): ResourceGroupUsageCostRequest {
    return ResourceGroupUsageCostRequestFromJSONTyped(json, false);
}

export function ResourceGroupUsageCostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourceGroupUsageCostRequest {
...
export function ResourceGroupUsageCostRequestToJSON(value?: ResourceGroupUsageCostRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
