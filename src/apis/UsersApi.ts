...
export class UsersApi extends runtime.BaseAPI {
  ...
  /**
   */
  async listUsersUserRaw(
    requestParameters: ListUsersUserRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<User>> {
    const queryParameters: any = {};
  ...
  async listUsersUser(
    ...
    const response = await this.listUsersUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async updateUserPasswordRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling updateUserPassword.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/Users/{id}/changepassword`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters.id)),
        ),
        method: 'PUT',
  ...
  async updateUserPassword(
    ...
    const response = await this.updateUserPasswordRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
