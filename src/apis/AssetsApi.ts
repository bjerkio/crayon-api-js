...
export class AssetsApi extends runtime.BaseAPI {
  /**
   */
  async createAssetCheckoutOrderRaw(
    requestParameters: CreateAssetCheckoutOrderRequest,
  ...
  /**
   */
  async createAssetCheckoutOrder(
    requestParameters: CreateAssetCheckoutOrderRequest,
    initOverrides?: RequestInit,
  ): Promise<void> {
  ...
  /**
   */
  async createAssetVerifyOrderRaw(
    requestParameters: CreateAssetVerifyOrderRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<AssetOrder>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      AssetOrderFromJSON(jsonValue),
    );
  }

  /**
   */
  async createAssetVerifyOrder(
    requestParameters: CreateAssetVerifyOrderRequest,
    initOverrides?: RequestInit,
  ): Promise<AssetOrder> {
    const response = await this.createAssetVerifyOrderRaw(
      requestParameters,
      initOverrides,
    );
  ...
  /**
   */
  async deleteAssetTagsRaw(
    requestParameters: DeleteAssetTagsRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.assetId === null ||
      requestParameters.assetId === undefined
    ) {
      throw new runtime.RequiredError(
        'assetId',
        'Required parameter requestParameters.assetId was null or undefined when calling deleteAssetTags.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/Assets/{assetId}/tags`.replace(
          `{${'assetId'}}`,
   ...
   */
  async getAssetRaw(
    requestParameters: GetAssetRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<Asset>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getAsset.',
      );
    }
  ...
  /**
   */
  async listAssetOrdersRaw(
    requestParameters: ListAssetOrdersRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<Array<AssetOrder>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(AssetOrderFromJSON),
    );
  }

  /**
   */
  async listAssetOrders(
    requestParameters: ListAssetOrdersRequest,
    initOverrides?: RequestInit,
  ): Promise<Array<AssetOrder>> {
    const response = await this.listAssetOrdersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async listAssetTagsRaw(
    requestParameters: ListAssetTagsRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.assetId === null ||
      ...
      throw new runtime.RequiredError(
        'assetId',
        'Required parameter requestParameters.assetId was null or undefined when calling listAssetTags.',
      );
    }
  ...
  async updateAssetRaw(
    requestParameters: UpdateAssetRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.assetId === null ||
      ...
      throw new runtime.RequiredError(
        'assetId',
        'Required parameter requestParameters.assetId was null or undefined when calling updateAsset.',
      );
    }
  ...
  /**
   */
  async updateAssetTagsRaw(
    requestParameters: UpdateAssetTagsRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.assetId === null ||
      ...
      throw new runtime.RequiredError(
        'assetId',
        'Required parameter requestParameters.assetId was null or undefined when calling updateAssetTags.',
      );
    }
