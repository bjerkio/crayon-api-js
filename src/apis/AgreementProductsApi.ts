...
export class AgreementProductsApi extends runtime.BaseAPI {
  /**
   */
  async createAgreementProductRaw(
    requestParameters: CreateAgreementProductRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<Array<AgreementProduct>>> {
    ...
    const response = await this.request(
      {
        ...
        body: AgreementProductFilterToJSON(
          requestParameters.agreementProductFilter,
        ),
      },
      initOverrides,
    );
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(AgreementProductFromJSON),
    );
  }

  /**
   */
  async createAgreementProduct(
    requestParameters: CreateAgreementProductRequest,
    initOverrides?: RequestInit,
  ): Promise<Array<AgreementProduct>> {
    const response = await this.createAgreementProductRaw(
      requestParameters,
      initOverrides,
    );
  ...
  /**
   */
  async listAgreementProductsRaw(
    requestParameters: ListAgreementProductsRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<Array<AgreementProduct>>> {
    const queryParameters: any = {};
    ...
    if (requestParameters.includePartNumbers) {
      queryParameters['Include.PartNumbers'] =
        requestParameters.includePartNumbers;
    }

    if (requestParameters.includePublisherIds) {
      queryParameters['Include.PublisherIds'] =
        requestParameters.includePublisherIds;
    }

    if (requestParameters.includePublisherNames) {
      queryParameters['Include.PublisherNames'] =
        requestParameters.includePublisherNames;
    }
    ...
    if (requestParameters.includeOperatingSystemNames) {
      queryParameters['Include.OperatingSystemNames'] =
        requestParameters.includeOperatingSystemNames;
    }

    if (requestParameters.includeLevelNames) {
      queryParameters['Include.LevelNames'] =
        requestParameters.includeLevelNames;
    }

    if (requestParameters.includeLanguageNames) {
      queryParameters['Include.LanguageNames'] =
        requestParameters.includeLanguageNames;
    }

    if (requestParameters.includeLicenseAgreementTypeNames) {
      queryParameters['Include.LicenseAgreementTypeNames'] =
        requestParameters.includeLicenseAgreementTypeNames;
    }

    if (requestParameters.includeLicenseTypeNames) {
      queryParameters['Include.LicenseTypeNames'] =
        requestParameters.includeLicenseTypeNames;
    }

    if (requestParameters.includeProductFamilyNames) {
      queryParameters['Include.ProductFamilyNames'] =
        requestParameters.includeProductFamilyNames;
    }

    if (requestParameters.includeProductTypeNames) {
      queryParameters['Include.ProductTypeNames'] =
        requestParameters.includeProductTypeNames;
    }

    if (requestParameters.includeProgramNames) {
      queryParameters['Include.ProgramNames'] =
        requestParameters.includeProgramNames;
    }

    if (requestParameters.includeOfferingNames) {
      queryParameters['Include.OfferingNames'] =
        requestParameters.includeOfferingNames;
    }

    if (requestParameters.includePurchasePeriodNames) {
      queryParameters['Include.PurchasePeriodNames'] =
        requestParameters.includePurchasePeriodNames;
    }

    if (requestParameters.includePurchaseUnitNames) {
      queryParameters['Include.PurchaseUnitNames'] =
        requestParameters.includePurchaseUnitNames;
    }

    if (requestParameters.includeVersionNames) {
      queryParameters['Include.VersionNames'] =
        requestParameters.includeVersionNames;
    }

    if (requestParameters.includeRegionNames) {
      queryParameters['Include.RegionNames'] =
        requestParameters.includeRegionNames;
    }

    if (requestParameters.includeProductCategoryNames) {
      queryParameters['Include.ProductCategoryNames'] =
        requestParameters.includeProductCategoryNames;
    }

    if (requestParameters.includeCatalogNames) {
      queryParameters['Include.CatalogNames'] =
        requestParameters.includeCatalogNames;
    }

    if (requestParameters.includeBillingCycles) {
      queryParameters['Include.BillingCycles'] =
        requestParameters.includeBillingCycles;
    }

    if (requestParameters.excludePartNumbers) {
      queryParameters['Exclude.PartNumbers'] =
        requestParameters.excludePartNumbers;
    }

    if (requestParameters.excludePublisherIds) {
      queryParameters['Exclude.PublisherIds'] =
        requestParameters.excludePublisherIds;
    }

    if (requestParameters.excludePublisherNames) {
      queryParameters['Exclude.PublisherNames'] =
        requestParameters.excludePublisherNames;
    }
    ...
    if (requestParameters.excludeOperatingSystemNames) {
      queryParameters['Exclude.OperatingSystemNames'] =
        requestParameters.excludeOperatingSystemNames;
    }

    if (requestParameters.excludeLevelNames) {
      queryParameters['Exclude.LevelNames'] =
        requestParameters.excludeLevelNames;
    }

    if (requestParameters.excludeLanguageNames) {
      queryParameters['Exclude.LanguageNames'] =
        requestParameters.excludeLanguageNames;
    }

    if (requestParameters.excludeLicenseAgreementTypeNames) {
      queryParameters['Exclude.LicenseAgreementTypeNames'] =
        requestParameters.excludeLicenseAgreementTypeNames;
    }

    if (requestParameters.excludeLicenseTypeNames) {
      queryParameters['Exclude.LicenseTypeNames'] =
        requestParameters.excludeLicenseTypeNames;
    }

    if (requestParameters.excludeProductFamilyNames) {
      queryParameters['Exclude.ProductFamilyNames'] =
        requestParameters.excludeProductFamilyNames;
    }

    if (requestParameters.excludeProductTypeNames) {
      queryParameters['Exclude.ProductTypeNames'] =
        requestParameters.excludeProductTypeNames;
    }

    if (requestParameters.excludeProgramNames) {
      queryParameters['Exclude.ProgramNames'] =
        requestParameters.excludeProgramNames;
    }

    if (requestParameters.excludeOfferingNames) {
      queryParameters['Exclude.OfferingNames'] =
        requestParameters.excludeOfferingNames;
    }

    if (requestParameters.excludePurchasePeriodNames) {
      queryParameters['Exclude.PurchasePeriodNames'] =
        requestParameters.excludePurchasePeriodNames;
    }

    if (requestParameters.excludePurchaseUnitNames) {
      queryParameters['Exclude.PurchaseUnitNames'] =
        requestParameters.excludePurchaseUnitNames;
    }

    if (requestParameters.excludeVersionNames) {
      queryParameters['Exclude.VersionNames'] =
        requestParameters.excludeVersionNames;
    }

    if (requestParameters.excludeRegionNames) {
      queryParameters['Exclude.RegionNames'] =
        requestParameters.excludeRegionNames;
    }

    if (requestParameters.excludeProductCategoryNames) {
      queryParameters['Exclude.ProductCategoryNames'] =
        requestParameters.excludeProductCategoryNames;
    }

    if (requestParameters.excludeCatalogNames) {
      queryParameters['Exclude.CatalogNames'] =
        requestParameters.excludeCatalogNames;
    }

    if (requestParameters.excludeBillingCycles) {
      queryParameters['Exclude.BillingCycles'] =
        requestParameters.excludeBillingCycles;
    }
    ...
    if (requestParameters.includeProductInformation !== undefined) {
      queryParameters['IncludeProductInformation'] =
        requestParameters.includeProductInformation;
    }
  ...
  /**
   */
  async listAgreementProducts(
    requestParameters: ListAgreementProductsRequest,
    initOverrides?: RequestInit,
  ): Promise<Array<AgreementProduct>> {
    const response = await this.listAgreementProductsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async listSupportedBillingCyclesRaw(
    requestParameters: ListSupportedBillingCyclesRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<Array<BillingCycleEnum>>> {
    if (
      requestParameters.partNumber === null ||
      requestParameters.partNumber === undefined
    ) {
      throw new runtime.RequiredError(
        'partNumber',
        'Required parameter requestParameters.partNumber was null or undefined when calling listSupportedBillingCycles.',
      );
    }
    ...
    if (requestParameters.resellerCustomerId !== undefined) {
      queryParameters['resellerCustomerId'] =
        requestParameters.resellerCustomerId;
    }
    ...
    const response = await this.request(
      {
        path: `/AgreementProducts/{partNumber}/supportedbillingcycles`.replace(
          `{${'partNumber'}}`,
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(BillingCycleEnumFromJSON),
    );
  }

  /**
   */
  async listSupportedBillingCycles(
    requestParameters: ListSupportedBillingCyclesRequest,
    initOverrides?: RequestInit,
  ): Promise<Array<BillingCycleEnum>> {
    const response = await this.listSupportedBillingCyclesRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async uploadAgreementProductsFileInXLSXRaw(
    requestParameters: UploadAgreementProductsFileInXLSXRequest,
    initOverrides?: RequestInit,
  ...
  /**
   */
  async uploadAgreementProductsFileInXLSX(
    requestParameters: UploadAgreementProductsFileInXLSXRequest,
    initOverrides?: RequestInit,
  ): Promise<void> {
    await this.uploadAgreementProductsFileInXLSXRaw(
      requestParameters,
      initOverrides,
    );
  }
